...
try:
    ...
    print("If you want to use RandomForest you have to install the following dependencies:\n"
...
class RandomForestOpt(Optimizer):

    def __init__(self, config_space, burnin=3000, n_iters=10000):

        super(RandomForestOpt, self).__init__(sacred_space_to_configspace(config_space))
